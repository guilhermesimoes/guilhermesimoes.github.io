...
From my analysis it looks like YouTube is using [SMIL animations]. I could not get those animations to work on browsers other than Chrome and it appears [that there is an intent to deprecate and remove SMIL]. I settled for the following technique:
...
[that there is an intent to deprecate and remove SMIL]: https://groups.google.com/a/chromium.org/forum/#!topic/blink-dev/5o0yiO440LM%5B1-25%5D
